...
import static com.o2osys.log.client.util.ReflectUtil.getValueByFieldName;
...
public class LogInterceptor implements Interceptor {
    ...
    public Object plugin(Object target) {
        ...
        if (target instanceof DefaultResultSetHandler && AnnotationOperateLogAspect.threadLocal.get() != null && AnnotationOperateLogAspect.threadLocal.get().getOperateLog()){
            ...
            //获取boundSql
            BoundSql boundSql = (BoundSql) getValueByFieldName(target, "boundSql");

            //sql请求的参数
            Object parameterObject = getValueByFieldName(boundSql, "parameterObject");

            //id参数
            String id = "";

            //获取sql 连接
            Executor executor = (Executor)getValueByFieldName(target, "executor");
